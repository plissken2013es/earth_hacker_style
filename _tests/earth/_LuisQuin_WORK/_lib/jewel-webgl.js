...
jewel.webgl = (function() {
    ...
    function createProgramObject(gl, vs, fs) {
        ...
        return program;
        // and then ----> gl.useProgram(program);
    }
    ...
    // rotateMat4(mvMatrix, Math.PI / 4, [0, 1, 0]); --> angle in radians
    ...
    // The model-view function assumes that the uniform in the shader is called uModelView
    ...
    function setNormalMatrix(gl, program, mv) {
     ...
     // The setProjection function assumes that the uniform in the shader is called uProjection
    ...
    return {
        ...
        createIdentityMat4:     createIdentityMat4,
        createIndexBuffer:      createIndexBuffer,
        //createPerspectiveMat4:  createPerspectiveMat4,
